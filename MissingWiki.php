...
if ( MW_ENTRY_POINT !== 'cli' ) {
	...
	$requestWikiUrl = 'https://meta.kyoikuportal.com/wiki/Special:RequestWiki?wpsubdomain=' .
		$wgDBname;
	...
	$output = <<<EOF
		...
		<html lang="en">
			<head>
				...
				<link rel="icon" type="image/x-icon" href="https://meta.kyoikuportal.com/favicon
				.ico" />
